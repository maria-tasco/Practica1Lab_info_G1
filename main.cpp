...
{
    int numprob=0;
    cout<<"ingrese el numero del problema: "<<endl; cin>>numprob;
    switch (numprob) {
        case 1:{
             cout<<"Ejercicio 1 Escriba un programa que pida dos números A y B e imprima en pantalla el residuo de la división A/B"<<endl;
             int a=0,b=0, div=0;
        ...
        case 3:
        {
            cout<<"Ejercicio 3 Escriba un programa que pida dos números A y B e imprima en pantalla el mayor."<<endl;
            int a=0,b=0;
